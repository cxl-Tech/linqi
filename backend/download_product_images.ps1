...
$IMAGE_URLS = @{
    ...
    5 = "https://images.unsplash.com/photo-1551024601-bec78aea704b?w=400&h=400&fit=crop"  # 瓜子
    6 = "https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop"  # 薯片
    7 = "https://images.unsplash.com/photo-1569263979104-865ab7cd8d13?w=400&h=400&fit=crop"  # 仙贝
