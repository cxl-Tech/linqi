<template>
  <div class="auth-page">
    <div class="auth-card">
      <a class="btn-back" @click="$router.push('/')">
      ...
      <div class="auth-header">
        ...
        <h2>创建账号</h2>
        <p class="auth-subtitle">加入临期优品，享受品质优惠</p>
      </div>
      <el-form :model="form" @submit.prevent="handleRegister">
        ...
        <el-form-item><el-input v-model="form.phone" placeholder="手机号（选填）" :prefix-icon="Phone" size="large" /></el-form-item>
        <el-form-item>
...
.auth-header h2 { font-size: 24px; font-weight: 700; color: var(--text-primary); margin-bottom: 8px; }
...
.link { text-align: center; margin-top: 20px; font-size: 13px; color: var(--text-secondary); }
.link a { color: var(--color-primary); font-weight: 600; }
.link a:hover { color: var(--color-primary-dark); }
.btn-back {
